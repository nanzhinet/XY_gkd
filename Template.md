...
[![Release](https://img.shields.io/badge/发行版-v{{VERSION}}-blue)](https://github.com/nanzhinet/XY_gkd/releases/latest)
...
![img](https://contrib.rocks/image?repo=nanzhinet/XY_gkd&max=200&_v={{VERSION}})
